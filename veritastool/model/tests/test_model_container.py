...
def test_model_container():
    ...
    container2 = ModelContainer(y_true=y_true, y_train=y_train, p_grp=p_grp, x_train=x_train,  x_test=x_test, \
                               model_object=model_obj, model_type =model_type,  y_pred = y_pred,\
                               y_prob = y_prob, sample_weight=sample_weight)
