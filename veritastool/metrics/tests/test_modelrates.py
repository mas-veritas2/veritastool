...
file = "C:/Users/charvi.mitish.somani/OneDrive - Accenture/MAS2/innersource_repo/veritas-toolkit/veritastool/examples/data/credit_score_dict.pickle"
...
def test_ModelRateUplift_init():
    ...
    file_prop = "C:/Users/charvi.mitish.somani/OneDrive - Accenture/MAS2/innersource_repo/veritas-toolkit/veritastool/examples/data/mktg_uplift_acq_dict.pickle"
    file_rej = "C:/Users/charvi.mitish.somani/OneDrive - Accenture/MAS2/innersource_repo/veritas-toolkit/veritastool/examples/data/mktg_uplift_rej_dict.pickle"
    ...
    container_rej = ModelContainer(y_true = y_true_rej, y_pred = y_pred_rej, y_prob = y_prob_rej, y_train= y_train_rej, \
                               ...
                               pos_label=['TR', 'CR'], neg_label=['TN', 'CN'], predict_op_name = "predict_proba")

    container_prop = container_rej.clone(y_true = y_true_prop, y_pred = y_pred_prop, y_prob = y_prob_prop, y_train= y_train_prop,\
                                model_object = model_object_prop,  pos_label=['TR', 'CR'], neg_label=['TN', 'CN'],predict_op_name = "predict_proba")
